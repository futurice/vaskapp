...
class Terms extends Component {
  render() {
    ...
    return (
      ...
      {!isIOS && <Header title="Terms of Service" onIconClick={() => this.props.navigator.pop()} />}
      <ScrollView style={styles.container}>
        <View style={styles.content}>

          <View style={styles.section}>
          <Text style={styles.title}>Terms and Conditions ("Terms")</Text>
          <Text style={styles.paragraph}>Last updated: Oct 27, 2017</Text>
          <Text style={styles.paragraph}>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the Vask mobile application and vaskapp.com site (the "Service") operated by Futurice Oy ("us", "we", or "our").</Text>
          ...
          <Text style={styles.paragraph}>If you have any questions about these Terms, please contact us via email vaskapp@futurice.com. Postal address: Kelloportinkatu 1 D, 33100 Tampere.</Text>
          </View>
